...
ALTER TABLE [dbo].[titles]
	ADD
	CONSTRAINT [DF__titles__type__2D27B809]
	DEFAULT ('UNDECIDED') FOR [type]
GO
ALTER TABLE [dbo].[titles]
	ADD
	CONSTRAINT [DF__titles__pubdate__2F10007B]
	DEFAULT (getdate()) FOR [pubdate]
GO
ALTER TABLE [dbo].[titles]
	WITH CHECK
	ADD CONSTRAINT [FK__titles__pub_id__2E1BDC42]
	FOREIGN KEY ([pub_id]) REFERENCES [dbo].[publishers] ([pub_id])
ALTER TABLE [dbo].[titles]
	CHECK CONSTRAINT [FK__titles__pub_id__2E1BDC42]
