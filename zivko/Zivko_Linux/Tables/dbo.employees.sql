...
ALTER TABLE [dbo].[employees]
	ADD
	CONSTRAINT [DF__employee__job_id__47DBAE45]
	DEFAULT ((1)) FOR [job_id]
GO
ALTER TABLE [dbo].[employees]
	ADD
	CONSTRAINT [DF__employee__job_lv__49C3F6B7]
	DEFAULT ((10)) FOR [job_lvl]
GO
ALTER TABLE [dbo].[employees]
	ADD
	CONSTRAINT [DF__employee__pub_id__4AB81AF0]
	DEFAULT ('9952') FOR [pub_id]
GO
ALTER TABLE [dbo].[employees]
	ADD
	CONSTRAINT [DF__employee__hire_d__4CA06362]
	DEFAULT (getdate()) FOR [hire_date]
GO
ALTER TABLE [dbo].[employees]
	WITH CHECK
	ADD CONSTRAINT [FK__employee__job_id__48CFD27E]
	FOREIGN KEY ([job_id]) REFERENCES [dbo].[jobs] ([job_id])
ALTER TABLE [dbo].[employees]
	CHECK CONSTRAINT [FK__employee__job_id__48CFD27E]

GO
ALTER TABLE [dbo].[employees]
	WITH CHECK
	ADD CONSTRAINT [FK__employee__pub_id__4BAC3F29]
	FOREIGN KEY ([pub_id]) REFERENCES [dbo].[publishers] ([pub_id])
ALTER TABLE [dbo].[employees]
	CHECK CONSTRAINT [FK__employee__pub_id__4BAC3F29]

GO
CREATE CLUSTERED INDEX [employee_ind]
	ON [dbo].[employees] ([lname], [fname], [minit])
	ON [PRIMARY]
GO
