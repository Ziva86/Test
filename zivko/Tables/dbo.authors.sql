...
ALTER TABLE [dbo].[authors]
	ADD
	CONSTRAINT [CK__authors__au_id__24927208]
	CHECK
	([au_id] like '[0-9][0-9][0-9]-[0-9][0-9]-[0-9][0-9][0-9][0-9]')
GO
ALTER TABLE [dbo].[authors]
CHECK CONSTRAINT [CK__authors__au_id__24927208]
GO
ALTER TABLE [dbo].[authors]
	ADD
	CONSTRAINT [CK__authors__zip__267ABA7A]
	CHECK
	([zip] like '[0-9][0-9][0-9][0-9][0-9]')
GO
ALTER TABLE [dbo].[authors]
CHECK CONSTRAINT [CK__authors__zip__267ABA7A]
GO
ALTER TABLE [dbo].[authors]
	ADD
	CONSTRAINT [DF__authors__phone__25869641]
